...
int WarGrey::STEM::MarioGroundAtlas::get_atlas_tile_index(size_t map_idx, int& xoff, int& yoff) {
...
void WarGrey::STEM::MarioGroundAtlas::feed_ground_tile_index(size_t map_idx, int& subrow, int& subcol) {
